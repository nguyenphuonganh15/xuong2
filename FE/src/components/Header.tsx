  ...
  return (
    <header>
      ...
      <div className="w-full flex justify-center items-center border-b">
        <div className="w-[1440px] lg:h-[76px] mb:h-[56px] flex justify-between *:flex *:items-center items-center">
          {/* icon menu */}
      ...
      <div className="w-full mb:hidden lg:block">
        <div className="w-full flex justify-center items-center *:flex *:justify-center">
          <div className="gap-x-[49.5px] h-[56px] items-center">
            <Link to="../src/products.html">Shop All</Link>
            <Link to="../src/detail.html">Flower</Link>
            <Link to="../src/cart.html">Edibles</Link>
